...
#'   \item{news}{Seemingly random information about the comic, like a backstory, contributors, merchandise link. May contain raw HTML}
#'   \item{title}{Title of the comic}
#'   \item{safe_title}{We still don't know what this is safe for. Maybe embedding?}
